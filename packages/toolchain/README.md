...
@paperback/toolchain/0.8.0-alpha.10 darwin-arm64 node-v16.13.0
...
_See code: [src/commands/bundle.ts](https://github.com/FaizanDurrani/paperback-cli/blob/v0.8.0-alpha.10/src/commands/bundle.ts)_
...
_See code: [src/commands/logcat.ts](https://github.com/FaizanDurrani/paperback-cli/blob/v0.8.0-alpha.10/src/commands/logcat.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/FaizanDurrani/paperback-cli/blob/v0.8.0-alpha.10/src/commands/serve.ts)_
<!-- commandsstop -->
