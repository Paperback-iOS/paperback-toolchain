...
// tslint:disable
// @ts-nocheck
import { PaperbackLogger } from './PDTLogger.js'
import type { BinaryWriteOptions } from '@protobuf-ts/runtime'
import type { BinaryReadOptions } from '@protobuf-ts/runtime'
import type { LogLine } from './PDTLogger.js'
import type { LogFilter } from './PDTLogger.js'
 ...
 * @generated from protobuf service PaperbackLogger
 */
export class PaperbackLoggerClient
  extends grpc.Client
  implements IPaperbackLoggerClient
{
  ...
  streamLogs(
    ...
    return this.makeServerStreamRequest<LogFilter, LogLine>(
      `/${PaperbackLogger.typeName}/${method.name}`,
      (value: LogFilter): Buffer =>
        Buffer.from(method.I.toBinary(value, this._binaryOptions)),
      (value: Buffer): LogLine =>
